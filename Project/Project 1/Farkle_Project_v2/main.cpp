 ...
 * Purpose:   Farkle Game Project v2 (game+loop+output to file)
 */
...
int main(int argc, char** argv) {
    ...
    //output to file
    out<<"roll 1 = "<<roll1<<endl;
    out<<"roll 2 = "<<roll2<<endl;
    out<<"roll 3 = "<<roll3<<endl;
    out<<"roll 4 = "<<roll4<<endl;
    out<<"roll 5 = "<<roll5<<endl;
    out<<"roll 6 = "<<roll6<<endl;
    out<<"your score is "<<point<<endl;
